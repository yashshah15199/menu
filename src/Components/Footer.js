  ...
  <div class="foooter-up" style={{backgroundColor:DataObj.backGroundColor}}>
    <div class="container">
      ...
      <div class="col-md-6">
            ...
            <p style={{color:DataObj.fontColor}} class="text-justify">Scanfcode.com <i>CODE WANTS TO BE SIMPLE </i> is an initiative  to help the upcoming programmers with the code. Scanfcode focuses on providing the most efficient code or snippets as the code wants to be simple. We will help programmers build up concepts in different programming languages that include C, C++, Java, HTML, CSS, Bootstrap, JavaScript, PHP, Android, SQL and Algorithm.</p>
          </div>
